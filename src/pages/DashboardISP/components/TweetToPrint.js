...
const TweetToPrint = ({ filteredTweet, tanggalMulaiLaporan, tanggalAkhirLaporan }) => {
    return (
        <div>
            <div className='flex flex-col  m-5'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <h6 className='text-base font-regular mb-8'>
                        Daftar Tweet dari <strong>{tanggalMulaiLaporan}</strong> sampai <strong>{tanggalAkhirLaporan}</strong>
                    </h6>
                </div>
